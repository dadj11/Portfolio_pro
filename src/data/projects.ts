...
export const projects = [
  {
    ...
    title: "YourMarket",
    description:
      "Plateforme de gestion commerciale et de vente en ligne permettant aux boutiques de gérer leurs produits, stocks, commandes, clients et ventes depuis une interface centralisée.",
    image: "/image/Yourmarket.png",
    images:["/image/yourmarket/yourmarket1.png","/image/yourmarket/yourmarket2.png","/image/yourmarket/yourmarket3.png"],
    technologies: ["Laravel", "Blade", "Tailwind CSS", "SQLite"],
    github: "https://github.com/dadj11/MarketPlace",
    demo: "#",
  },
